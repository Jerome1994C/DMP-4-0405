...
void nand_calculate_ecc(const unsigned char *data, unsigned char *ecc)
{
	unsigned int i;
...
int nand_correct_data(unsigned char *data, unsigned char *read_ecc, unsigned char *test_ecc)
{
